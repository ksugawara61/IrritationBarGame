========================================================================
    アプリケーション: IrritationBarGameVer3 プロジェクトの概要
========================================================================

この IrritationBarGameVer3 アプリケーションは、AppWizard により作成されました。  

このファイルには、IrritationBarGameVer3 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

IrritationBarGameVer3.vcxproj
...
IrritationBarGameVer3.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、IrritationBarGameVer3.pch 
